package com.v2.okcredit.activity
...
import com.v2.okcredit.BuildConfig
import com.v2.okcredit.LanguageSelectionActivity
...
import com.v2.okcredit.activity.navigationActivity.AccountActivity
import com.v2.okcredit.activity.navigationActivity.ProfileActivity
import com.v2.okcredit.activity.navigationActivity.WebViewActivity
import com.v2.okcredit.adapter.ContactsPagerAdapter
import com.v2.okcredit.adapter.CustomerAdapter
import com.v2.okcredit.adapter.PhoneContactsAdapter
...
class HomeActivity : BaseActivity(), MaterialSearchBar.OnSearchActionListener, TextWatcher,
    View.OnClickListener, NavigationView.OnNavigationItemSelectedListener,TransactionDateListener {

  private lateinit var binding: ActivityHomeBinding
    private val tag: String = "HomeActivity"
    private val REQUEST_READ_CONTACTS = 101
    private var transactionModel : Transaction?=null
    ...
    private fun initViews() {
        ...
        binding.tvVersionNo.text = getString(R.string.versionNo, BuildConfig.VERSION_NAME)

        binding.etMaterialSearch.setSearchIcon(0)
        binding.etMaterialSearch.setOnSearchActionListener(this)
        binding.etMaterialSearch.addTextChangeListener(this)
    ...
    private fun drawerSetup() {
        ...
        val headerView = binding.navigationView.inflateHeaderView(R.layout.nav_header_main)
        val llHeaderMain = headerView.findViewById(R.id.llHeaderMain) as LinearLayout
        binding.navigationView.setNavigationItemSelectedListener(this)
        binding. navigationView.setCheckedItem(R.id.nav_account)
...
//    }
        ...
        disposable!!.add(
            Single.create<User> { e -> e.onSuccess(addCustomerToDb(t)) }
                ...
                .subscribe({
                    ...
                    binding.etMaterialSearch.disableSearch()
                }) { handleError(it) }
        )
    }
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.fbAdd -> {
                if (!binding.etMaterialSearch.isSearchEnabled) binding.etMaterialSearch.enableSearch()
            }
        }
    }
    ...
    override fun afterTextChanged(s: Editable?) {
        ...
        if (s.toString().isNotEmpty()) {
            binding.etMaterialSearch.setClearIcon(R.drawable.ic_close)
    ...
    private fun setUpContactsUI() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS)
            ...
            if (binding.etMaterialSearch.isSearchEnabled) {
    ...
    override fun getDate(transaction: Transaction) {
